    ...
    translations: {
        he: {
            ...
            splash: {
                ...
                howToPlay: {
                    title: 'איך משחקים?',
                    text: 'בכל שלב תראו תמונה גדולה ממדינה אחת. משימתכם היא למצוא את כל הפריטים המיוחדים שמסומנים בעיגול בצד. לחצו על הפריט כשאתם מוצאים אותו, ותלמדו עליו עוד! השתמשו בגלגל העכבר כדי לזום ובגרירה כדי לנוע בתמונה.',
                    button: 'המשך'
                },
                about: {
                    title: 'על רכבת החיג\'אז',
